...
for (date in date_sequence){
  ...
  vnfv30.url.pfx <- c('https://eogdata.mines.edu/wwwdata/viirs_products/vnf/v30/VNF_npp_d',
    '_noaa_v30-ez.csv.gz')
  
  # create the url to request
  data_url <- paste0(vnfv30.url.pfx[1], date_string, vnfv30.url.pfx[2], sep = "")
...
```{r}
saveRDS(vnf_pb_new, "./pb_vnf/pb-vnf_new.rds")
```
