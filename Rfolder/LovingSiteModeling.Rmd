...
count_poll_gam <- gam(radon ~ date + mean_no2 + mean_nox + mean_no + mean_room_f + mean_press + mean_wsp + mean_relh + mean_solar + mean_tempf + mean_o3  + flare, data = flaring_sameday_count_poll)
